...
// If alias ever breaks, you can switch this to ../components/...
...
export default function Landing() {
  // Track landing page view (safe if analytics is a no-op)
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary/5">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              ...
              <p className="mt-6 text-xl text-muted-foreground leading-relaxed">
                The free parental leave financial calculator. Know exactly how much
                savings you need and plan your return to work with confidence.
              </p>
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/calculator">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto text-lg h-14 px-8 rounded-full shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all"
      ...
      <footer className="py-12 text-center text-muted-foreground text-sm border-t border-border/50">
        <p>© {new Date().getFullYear()} LeaveCalc. Built for parents, by parents.</p>
      </footer>
    </div>
  );
}
